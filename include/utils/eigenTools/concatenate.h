...
template <typename T>
inline Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> concatenate(
    Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> in_1,
    Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic> in_2, int direction) {
...
template <typename T>
inline Eigen::SparseMatrix<T> concatenate(Eigen::SparseMatrix<T> in_1,
                                          Eigen::SparseMatrix<T> in_2,
                                          int direction) {
