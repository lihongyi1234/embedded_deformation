...
inline bool readPLY(FILE *ply_file, std::vector<std::vector<Vtype> > &V,
                    std::vector<std::vector<Ftype> > &F,
                    std::vector<std::vector<Ntype> > &N,
                    std::vector<std::vector<UVtype> > &UV);
...
template <typename Vtype, typename Ftype, typename Ntype, typename UVtype>
inline bool igl::readPLY(const std::string filename,
                         std::vector<std::vector<Vtype> > &V,
                         std::vector<std::vector<Ftype> > &F,
                         std::vector<std::vector<Ntype> > &N,
                         std::vector<std::vector<UVtype> > &UV) {
...
template <typename Vtype, typename Ftype, typename Ntype, typename UVtype>
inline bool igl::readPLY(FILE *ply_file, std::vector<std::vector<Vtype> > &V,
                         std::vector<std::vector<Ftype> > &F,
                         std::vector<std::vector<Ntype> > &N,
                         std::vector<std::vector<UVtype> > &UV) {
  using namespace std;
  ...
  int nelems;
  char **elem_names;
  igl::ply::PlyFile *in_ply =
      igl::ply::ply_read(ply_file, &nelems, &elem_names);
  if (in_ply == NULL) {
    return false;
  }
  ...
  if (plist != NULL) {
    ...
    ply_get_other_properties(in_ply, "vertex", offsetof(Vertex, other_props));
